...
//            }
    ...
    public @ResponseBody Object updateDataForProcess(@RequestParam("upfile") CommonsMultipartFile upfile, @Valid EditProcessDTO editProcessDTO, BindingResult result,
